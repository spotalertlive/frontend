// ===========================================================
// SpotAlert Dashboard – FINAL PRODUCTION VERSION
...
// ===========================================================
// KNOWN FACES (✔ FIXED – MATCHES BACKEND EXACTLY)
// ===========================================================
...
if (faceUploadForm) {
  faceUploadForm.addEventListener("submit", async (e) => {
    ...
    const parts = faceLabel.value.trim().split(" ");
    ...
    fd.append("images", faceImage.files[0]); // backend expects images[]
