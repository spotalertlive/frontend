...
// ========================================================
// 1️⃣ GET LOGGED-IN USER INFO  ✅ FIXED (NO PLACEHOLDER)
// ========================================================
function getCurrentUser() {
  try {
    const raw = localStorage.getItem("spotalert_user");
    if (!raw) return null;
...
async function connectCamera() {
  ...
  try {
    ...
    // ========================================================
    // ✅ REGISTER CAMERA IN BACKEND
    // ========================================================
    try {
      await fetch(`${API_BASE}/camera/register`, {
        method: "POST",
      ...
      console.error("⚠️ Camera registration failed:", regErr);
    }
